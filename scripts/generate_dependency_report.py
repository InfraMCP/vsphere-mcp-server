...
def generate_report():
    ...
    core_deps = ["mcp", "requests", "urllib3"]
    ...
    report["security_notes"] = [
        ...
        "vSphere credentials are stored securely in macOS Keychain",
        "SSL verification is disabled for enterprise vSphere environments"
    ]
